...
export function detrimentRoll(
  detriment, gametime, user, setGoldPerSecond, setActiveTime, setGold, setUser){
...
export function shutOffEffect(detriment,  gametime, activeTime, setGoldPerSecond, setDetriment){
  Object.keys(detriment).map(item => {
